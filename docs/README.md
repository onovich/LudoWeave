# LudoWeave Documentation

本目录保存 LudoWeave 当前架构、合作材料、决策记录和研发计划。
...
- [v0.4 Goal 模式执行指南](goal-mode/ludoweave-v0.4-goal-mode-execution-guide.md) - 16 轮会话预算
- [v0.5 Goal 模式执行指南](goal-mode/ludoweave-v0.5-goal-mode-execution-guide.md) - 16 轮会话预算
- [v0.6 Goal 模式执行指南](goal-mode/ludoweave-v0.6-goal-mode-execution-guide.md) - 16 轮会话预算
- [v0.7 Goal 模式执行指南](goal-mode/ludoweave-v0.7-goal-mode-execution-guide.md) - 16 轮会话预算
- [v0.8 Goal 模式执行指南](goal-mode/ludoweave-v0.8-goal-mode-execution-guide.md) - 16 轮会话预算
- [v0.9 Goal 模式执行指南](goal-mode/ludoweave-v0.9-goal-mode-execution-guide.md) - 16 轮会话预算
...
- [v0.6 Integration Status](roadmap/ludoweave-v0.6-integration-status.md)
- [v0.6 Release Notes Draft](release/ludoweave-v0.6-release-notes-draft.md)
- [v0.6 Final Report](release/ludoweave-v0.6-final-report.md)
- [v0.6 Final Validation Log](release/ludoweave-v0.6-final-validation-log.md)
...
- [v0.9 Gap And Decision Ledger](sinan-cooperation/ludoweave-v0.9-gap-ledger.md)
...
- [ADR-0002: Headless-first 与完整 ResolvedUiFrame snapshot](adr/0002-headless-first-and-full-frame-snapshot.md)
...
- [Sinan RFC-003: Runtime UI ViewModel](sinan-cooperation/rfc-003-sinan-runtime-ui-viewmodel.md)
- [Sinan 技术顾问建议](sinan-cooperation/sinan-technical-advisory-2026-06-20.md)
- [Sinan 合作沟通函](sinan-cooperation/sinan-business-letter-2026-06-20.md)
